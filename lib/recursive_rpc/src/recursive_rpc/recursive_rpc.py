...
def activate_ssh_none(host: int | str, user: str, port: int, password: Optional[str] = None):
    # === CONFIGURATION ===
    REMOTE_HOST = host
    REMOTE_USER = user
    REMOTE_PORT = port
